...
const products = [
    ...
    {"id" : 1, nombre: "Veggie", precio: 1800, detalle : "Pan de espinaca, medallon vegetariano, tomate, queso, cebolla.", imagen : "image/veggie.jfif"},
    {"id" : 2, nombre: "Italiana" , precio: 2050, detalle: "Burger, muzzarella, tomate asado, rucula y alioli verde.", imagen: "image/italiana.jpg"},
